...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="target inline-flex items-center gap-2 px-2 font-mono text-[0.75rem] uppercase tracking-[0.1em] text-[var(--text-2)] transition-colors hover:text-[var(--text)] sm:px-3"
    >
